...
import com.rhinodesktop.foreorder_golf_consumer1.events.UserImageUpdatedEvent;
import com.rhinodesktop.foreorder_golf_consumer1.facebook.ForeOrderLogoutHandler;
import com.rhinodesktop.foreorder_golf_consumer1.listeners.TitleImageOnOffsetChangedListener;
...
import com.rhinodesktop.foreorder_golf_consumer1.utils.imagecaptureutils.ActivityImageCaptureUtils;
import com.rhinodesktop.foreorder_golf_consumer1.utils.imagecaptureutils.ImageCaptureUtils;
...
//                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(Constants.PRIVACY_POLICY_URL));
