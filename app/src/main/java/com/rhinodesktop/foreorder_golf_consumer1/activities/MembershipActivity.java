...
import com.rhinodesktop.foreorder_golf_consumer1.adapters.MembershipListAdapter;
import com.rhinodesktop.foreorder_golf_consumer1.events.MembershipAddEvent;
import com.rhinodesktop.foreorder_golf_consumer1.events.MembershipListEvent;
import com.rhinodesktop.foreorder_golf_consumer1.events.PrivateClubsListEvent;
import com.rhinodesktop.foreorder_golf_consumer1.events.RemoveMembershipEvent;
import com.rhinodesktop.foreorder_golf_consumer1.managers.ForeOrderActivityAndAnimateManager;
import com.rhinodesktop.foreorder_golf_consumer1.managers.apirequestmanagers.MembershipApiManager;
...
public class MembershipActivity extends NoInternetAppBarActivity implements AdapterView.OnItemSelectedListener {
    ...
    private void initSpinner() {
        ...
        MembershipApiManager.getPrivateClubsList(mRealm.where(User.class).findFirst().getUserId());
    }
