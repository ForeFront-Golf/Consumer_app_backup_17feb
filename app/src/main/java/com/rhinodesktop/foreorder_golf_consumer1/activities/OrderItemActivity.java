...
import com.rhinodesktop.foreorder_golf_consumer1.events.MultiOptionCheckedEvent;
import com.rhinodesktop.foreorder_golf_consumer1.events.SingleOptionCheckedEvent;
import com.rhinodesktop.foreorder_golf_consumer1.fragments.ChoiceFragment;
import com.rhinodesktop.foreorder_golf_consumer1.fragments.MultiChoiceFragment;
import com.rhinodesktop.foreorder_golf_consumer1.fragments.SingleChoiceFragment;
...
import com.rhinodesktop.foreorder_golf_consumer1.models.OptionGroup;
import com.rhinodesktop.foreorder_golf_consumer1.models.OptionGroupWithItems;
...
public class OrderItemActivity extends OrderItemAppBarActivity {
    ...
    private void initViews() {
        ...
        ImageView image = findViewById( R.id.imageview_menu_item_backdrop);
        Glide.with(image).load(Constants.IMAGE_BASE_URL+menuItem.getPhotoUrl()).into(image);
        Log.e("MenuImage","ÖrderItem"+menuItem.getPhotoUrl());
        setTotalItemPriceTexts();
