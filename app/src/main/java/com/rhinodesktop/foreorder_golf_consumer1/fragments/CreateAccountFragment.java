...
import com.rhinodesktop.foreorder_golf_consumer1.events.DuplicateKeyEvent;
...
import com.rhinodesktop.foreorder_golf_consumer1.utils.imagecaptureutils.FragmentImageCaptureUtils;
...
//                Toast.makeText(getContext(), "Updated " + selectedCountry.getPhoneCode(), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void confirmCreateAccount() {
        ...
        {
            phoneNumber = "+"+countrycode.concat(phoneNumberEditText.getText().toString()).trim();
        }
