package com.rhinodesktop.foreorder_golf_consumer1.networking;
...
import com.rhinodesktop.foreorder_golf_consumer1.managers.CurrentOrder;
...
public class ApiRequests extends ApiRequestsUtility {
    ...
    public Call getPrivateClubsList( int userId) throws GeneralSecurityException {
        String privateClubsListUrl = Constants.CLUB + "?" + Constants.PRIVATE + "=" + Constants.TRUE+ "&" +Constants.USER + "=" + userId;
    ...
    public Call updateCurrentUserLocation(int userId, Location location) throws GeneralSecurityException {
        ...
        Map<String, Object> params = new HashMap<>();
        params.put(Constants.LAT, /*35.949905 */location.getLatitude());
        params.put(Constants.LON,/* -121.1430133*/location.getLongitude());
...
//    public Call getCoursesForCurrentClub(int clubId) throws GeneralSecurityException {
//        String courseUrl = Constants.COURSE + "/" + clubId + "/" + Constants.MENU
//                + "?" + Constants.FULL_TRUE;
//        return getRequest(locationUrl);
//    }

    public Call getClubsNearCurrentUser(int userId/*Location location*/) throws GeneralSecurityException {
//        String clubUrl = Constants.CLUB + "?" + Constants.LAT + "=" +/* 35.949905*/ location.getLatitude() + "&"
//                + Constants.LON + "=" +/* -121.1430133*/location.getLongitude();

        String clubUrl = Constants.CLUB + "?" + Constants.PRIVATE + "=" + Constants.TRUE+ "&" +Constants.USER + "=" + userId;

        http://18.143.85.82:8088/api/club?private = true & user =609
...
//        /user/609/club /90/menu/89/order
    }
